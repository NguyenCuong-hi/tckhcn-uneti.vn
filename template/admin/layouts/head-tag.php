    ...
    <div class="container-fluid">
        <div class="row">
            <nav class="col-md-2 d-none d-md-block pt-3 bg-sidebar sidebar px-0">
                ...
                <a class="text-decoration-none d-block py-1 px-2 mt-1" href="<?= url('admin/category') ?>"><i class="fas fa-clipboard-list"></i> Thể loại</a>
                <a class="text-decoration-none d-block py-1 px-2 mt-1" href="<?= url('admin/post') ?>"><i class="fas fa-newspaper"></i> Bài đăng</a>
                <a class="text-decoration-none d-block py-1 px-2 mt-1" href="<?= url('admin/file') ?>"><i class="fas fa-newspaper"></i> Tệp tin</a>
            ...
            <a class="text-decoration-none d-block py-1 px-2 mt-1" href="<?= url('admin/web-setting') ?>"><i class="fas fa-tools"></i> Cài đặt</a>
            </nav>
