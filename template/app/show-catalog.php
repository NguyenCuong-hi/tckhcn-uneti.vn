...
<div class="body_getdata" style="display: flex; margin-top: 30px; margin-right: 32px">
    ...
    <div style="width: 62%; margin: 0; padding: 4px; box-sizing: border-box">
        <div style="display: flex; flex-direction: column; align-items: center;">
            ...
            <img style="width: 70%;  " src="https://uneti.edu.vn/wp-content/uploads/2022/09/Bia-1-so-32-scaled.jpg" alt="">
            </div>
  <div style="display: flex; justify-content: center; margin-bottom: 70px;">
    <img style="max-width: 70%;  " src="https://uneti.edu.vn/wp-content/uploads/2022/09/Muc-luc-so-32-TV-scaled.jpg" alt="">
  </div>
  <div style="display: flex; justify-content: center; margin-bottom: 70px;">
    <img style="max-width: 70%;" src="https://uneti.edu.vn/wp-content/uploads/2022/09/Muc-luc-so-32-TA-scaled.jpg" alt="">
  </div>
