...
class SendPostToAdmin
{
    ...
    public function sendPost()
    {
        ...
        $mail_recipient = "phamanhdung2k2@gmail.com";
        $subject = "Mail đã được gửi";
//        ---------------------------- Làm vs Auth() ----------------
//        $mail = new Auth();

//        // Kiểm tra xem đã nhấn nút Gửi chưa
...
//                $mail->sendMail($mail_recipient, $email, $subject, $message, $target_file);
//
//            } else {
